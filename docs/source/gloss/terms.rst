...
.. glossary::
    ...
    **csv data**
        Comma-Separated-Values. Ένα αρχείο με *τιμές-διαχωρισμένες-με-κόμμα* είναι ένα αρχείο απλού κειμένου (plain text), οριοθετημένου με κόμμα. Κάθε γραμμή κειμένου είναι μία *εγγραφή δεδομένων* (data record), που αποτελείται από ένα ή περισσότερα πεδία, διαχωρισμένα με κόμμα. Το κόμμα σε αυτή την περίπτωσξ είναι οριοθέτης των τιμών (δες τι είναι οι :term:`οριοθέτες <Delimeter>`).
        ...
        Δηλαδή να περιέχει δεδομένα ατόμων όπως όνομα, επίθετο και ηλικία.
        
        Περισσότερες λεπτομέρειες σε `Wikipedia: Comma-separated values <https://en.wikipedia.org/wiki/Comma-separated_values>`_
