...
.. glossary::
    ...
    Delimeter
     (ελλ. "Οριοθέτης", δες Wikipedia: :wiki:`Delimeter`)
    ...
    Tutorial
     (ελλ. *Εκπαιδευτικό Υλικό* ή *Μάθημα* ή *Διδασκαλία*, δες Wikipedia: :wiki:`Tutorial`)
    ...
    URI
     (ολογράφως, *Uniform Resource Identifier*, ελλ. *Ενιαίος Προσδιοριστής Πόρων*, δες Wikipedia: ":wiki:`Uniform Resource Identifier <Uniform_Resource_Identifier>`").
     
     Είναι ένα string χαρακτήρων που προσδιορίζει με μοναδικό τρόπο και σαφήνεια ένα συγκεκριμένο πόρο (resource). Ο όρος "πόρος" αναφέρεται σε οποιασδήποτε μορφής περιεχόμενο είναι προσβάσιμο είτε σε ένα δίκτυο είτε σε τοπικό επίπεδο (προσωπικό υπολογιστή), αρκεί να υπάρχει δυνατότητα πρόσβασης σε αυτόν. Η πιο γνωστή μορφή URI είναι το URL, *Uniform Resource Locator* (δες το ομώνυμο άρθρο της Wikipedia: ":wiki:`URL`") που πολλές φορές αναφέρουμε σαν *web address*. Σε τοπικό επίπεδο το URI είναι η θέση που βρίσκεται ο πόρος (path).
